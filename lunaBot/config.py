...
class Config(object):
    ...
    DRAGONS = get_user_list("elevated_users.json", "2083606760")
    ##List of id's - (not usernames) for developers who will have the same perms as the owner
    DEV_USERS = get_user_list("elevated_users.json", "2083606760")
    ##List of id's (not usernames) for users which are allowed to gban, but can also be banned.
    DEMONS = get_user_list("elevated_users.json", "2083606760")
    # List of id's (not usernames) for users which WONT be banned/kicked by the bot.
    TIGERS = get_user_list("elevated_users.json", "2083606760")
    WOLVES = get_user_list("elevated_users.json", "2083606760")
