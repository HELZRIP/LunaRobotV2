...
async def awake(event):
  ...
  LUNA = "**Holla I'm Akeno!** \n\n"
  LUNA += "🔴 **I'm Working Properly** \n\n"
  LUNA += "🔴 **My Master : [Dream Garden (rey)](https://t.me/helzrip)** \n\n"
  LUNA += f"🔴 **Telethon Version : {tlhver}** \n\n"
  LUNA += f"🔴 **Pyrogram Version : {pyrover}** \n\n"
  LUNA += "**Thanks For Adding Me Here ❤️**"
  BUTTON = [[Button.url("ʜᴇʟᴘ", "https://t.me/Akeno?start=help"), Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/Rsupportprobot")]]
